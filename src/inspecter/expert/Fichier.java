 ...
 * @author Alphonse
 */
public class Fichier extends javax.swing.JDialog {

    /**
     * Creates new form Message
     */
    public Fichier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Code source prolog");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Fichier dialog = new Fichier(new javax.swing.JFrame(), true);
